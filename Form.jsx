    ...
    <div className='main-div'>
        <div className='form'>
          <form onSubmit={handlesubmit}>
            ...
            Name:<input type='text' placeholder='Enter the name'value={user} onChange={handle1}/><span>{usererr?'invalid entry':''}</span><br></br><br></br>
            Email:<input type='email' placeholder='Enter the email' onChange={(e)=>handle(e.target.value)}/><span>{error1?'Invalid email':''}</span><br></br><br></br>
            Phone:<input type='number' placeholder='Enter the number' value={num} onChange={handle3}/><span>{numerr?'Invalid number':''}</span><br></br><br></br>
           ...
           Cities: { state && <select style={{width:'255px',height:'32px',borderRadius:'15px',textAlign:'center'}}>
            ...
            Yourself:<textarea style={{width:'250px',height:'32px' ,borderRadius:'15px'}} onChange={handle4} value={text}></textarea><span>{texterr?'above 250 char not allowed':''}</span><br></br><br></br>
